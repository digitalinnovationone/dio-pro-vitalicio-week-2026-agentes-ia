...
>
> **Conceitos abordados:** `CLAUDE.md` `Permissions` `Plan Mode` `Context` `Compaction`

---

## Resumo em produção

O resumo desta sessão será publicado em breve, após a live acontecer. Ele será gerado a partir da transcrição da gravação, com um prompt padronizado que rotula cada um dos 12 conceitos essenciais do Claude Code no momento em que aparecem.
